...
export default function Product({product}) {
  ...
  return (
      <div class="p-4 md:w-1/3 hover:translate-y-1 hover:scale-105 duration-75">
        <Link to={product._id}>
        <div class="h-full border-2 border-gray-800 rounded-lg overflow-hidden">
          <img class="lg:h-60 md:h-36 object-cover object-center" src={product.images[0].url} alt="blog" />
          <div class="p-6">
            ...
            <p class="leading-relaxed mb-3 text-yellow-500 font-semibold">Rs. {product.price}</p>
          </div>
        </div>
        </Link>
      </div>
